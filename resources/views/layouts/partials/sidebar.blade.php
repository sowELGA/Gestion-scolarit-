{{-- FIX : h-screen + overflow-y-auto sur le sidebar lui-même --}}
{{-- sticky top-0 pour qu'il reste en place --}}
<div x-data="{
    ...
    class="sticky top-0 h-screen flex flex-col bg-gradient-to-b from-gray-900 to-gray-800
           text-gray-200 shadow-xl transition-all duration-300 overflow-hidden shrink-0"
    ...
    {{-- Toggle --}}
    <button @click="open = !open" class="p-3 hover:bg-gray-700 transition text-gray-300 hover:text-white shrink-0">
        <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
        </svg>
    </button>

    {{-- Menu — scrollable si trop d'items --}}
    <nav class="mt-6 flex-1 space-y-2 px-2 overflow-y-auto">
        @php
            $menuItems = [
    ...
    {{-- Bas sidebar --}}
    <div class="p-4 text-xs text-gray-400 border-t border-gray-700 shrink-0" x-show="open" x-cloak>
        Version 1.0
    </div>
</div>
